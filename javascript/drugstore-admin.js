...
$.ajax({
    ...
    if (response.success == 1) {
        if (response.isAdmin != "1" || response.dbName != "Drugstore")
...
$('#add_btn').click(function() {
    ...
    if (drugname === "")
        ...
        $.ajax({
            url: "http://localhost/phpmyadmin/TestProject/Drugstore/AddNewDrug.php",
            type: "POST",
...
$('#list_of_medicines').on('click', '.delete_btn', function() {
    ...
    $.ajax({
        url: "http://localhost/phpmyadmin/TestProject/Drugstore/DeleteDrug.php",
        type: "GET",
        data: {mid: mid},
        dataType: "json",
    }).done(function (response) {
...
$('#list_of_medicines').on('click', '.update_btn', function() {
    ...
    if (drugname === "")
        ...
        $.ajax({
            url: "http://localhost/phpmyadmin/TestProject/Drugstore/EditDrug.php",
            type: "POST",
